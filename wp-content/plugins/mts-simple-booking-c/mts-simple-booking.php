...
class MTS_Simple_Booking {
    ...
    const PAGE_BETWEEN_LIST = 'simple-booking-list&action=between';
	...
	public function add_admin_menu() {
        ...
        add_submenu_page(self::ADMIN_MENU, __('List Between Booking', self::DOMAIN), __('List Between Booking', self::DOMAIN), 'administrator', self::PAGE_BETWEEN_LIST, array($this, 'menu_between_list'));
